...
define config.name = _("Sotrudnik")
...
define gui.about = _p("""
Игра разработана Артёмиком с любовью и заботой!

Особые благодарности:

 - Артём - без него собстенно и не было бы игры!

 - Настя - советы по позиционированию и общему визуалу очень были полезны

 - Илья - идейный вдохновитель и лицо игры

 - Полина - главный фанат, которого никак нельзя было расстроить!
""")
...
define config.save_directory = "Sotrudnik-1743541520"
